...
searchPhone
 ...
 Экспортируем все возможные варианты событий
 Даем им строковое значение для последующего применения в модели Switch/Case

Синхронные по 1 типу
Асинхронные по 3 типа
*/
